        ...
        if (item.key === Number(localStorage.getItem('Item'))) {
            return (
                <div>
                    ...
                    <div
                        className={'landing-sword-text flex-column grid__item-6-columns margin-left-auto align-flex-start'}>
                        <h3 id={'landing-sword-title'}
                            className={'h2 margin-top-0'}>{'Aerondight, The Witcher'}</h3>
                        ...
                        <div className={'margin-top-auto'}>
                            <p className={'h2 slider-price'}><span
                                className={'color-gray crossed-text'}>489€</span><span> - 275€</span></p>
                            <Button color={'primary'}
                                    link={'/cesta'}>{t('productDetails:addToCart')}</Button>
                        </div>
                    </div>
                </div>
            )
